...
import s from './MonthView.css';
import Sidebar from '../../components/Sidebar';

const title = 'Month View';

function MonthView({ week }, context) {
...
MonthView.contextTypes = { setTitle: PropTypes.func.isRequired };

export default withStyles(s)(MonthView);
